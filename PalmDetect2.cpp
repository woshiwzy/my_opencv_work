...
//    vector<Mat> channels;
//    //模板图片，是Cr颜色通道的人手图像截图
//Mat tmpl = imread("/Users/wangzy/sutdy/temp/bwz.jpeg",CV_8UC1);
//    
//    
//    bool stop = false;
//    while (!stop)
...
//        
//        
//                cvtColor(frame, tmat, CV_RGB2GRAY);
//        
//        Mat struElmen = getStructuringElement(MORPH_RECT,Size(3, 3), Point(-1, -1));
//        morphologyEx(tmat, tmat, cv::MORPH_CLOSE, struElmen);
//        
//                findContours(tmat, contours, hierarchy,CV_RETR_EXTERNAL, CV_CHAIN_APPROX_SIMPLE);
//        
//        
//        
//        
...
//                {
//        
//                    Rect rect=boundingRect(contours.at(0));
//        
//                    cout<<rect.width<<" "<<rect.height<<" x "<<rect.x<<" y :"<<rect.y<<endl;
//                    
////                    int area=fabs(contourArea(Mat(contours[i])));
//        
//                    if ( /*area> 2000 && area<4000 && */(rect.width>200|| rect.height>200)){
//                    
//                    resContours.push_back(contours[i]);
//                    Tool::drawRectangle(frame, rect);
//                        
//                    
//                    }
//                    
...
////                tempMat.setTo(0);
////                
////                drawContours(tempMat, resContours, -1,Scalar(255, 200, 0), CV_FILLED);
//
//        
//        
